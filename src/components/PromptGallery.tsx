        ...
        {filteredPrompts.length > visibleCount && (
          <div className="mt-16 text-center">
            <button 
              ...
              className="rounded-full bg-secondary/50 hover:bg-secondary/80 text-foreground font-medium px-8 py-3 transition-colors border border-border/40 shadow-sm backdrop-blur-sm cursor-pointer"
            >
              Load More Prompts
            </button>
          </div>
